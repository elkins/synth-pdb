...
class ProteinQualityClassifier:
    """
    AI-powered classifier to predict if a protein structure is "High Quality" (biophysically plausible)
    or "Low Quality" (likely has steric clashes or geometry violations).
    
    It uses a lightweight RandomForest model trained on synth-pdb generated data:
